...
/**
 * Created by ES-BF-IT-126 on 2017/4/25.
 */
public class TestTridentFuntion {
    ...
    public static StormTopology buildTopology(LocalDRPC drpc) {
        ...
        topology.newDRPCStream("words", drpc).each(new Fields("args"),new MyFilter());
//                .groupBy(new Fields(
...
//            System.out.println("DRPC RESULT: " + drpc.execute("words", "to to"));
//            Thread.sleep(1000);
            for (int i = 0; i < 100; i++) {
                System.out.println("DRPC RESULT: " + drpc.execute("words", "to the"));
                Thread.sleep(1000);
            }
        }
        else {
